...
struct tet_testlist tet_testlist[] = {
	{utc_mm_radio_seek_func_01, 1},
	{utc_mm_radio_seek_func_02, 2},
	{utc_mm_radio_seek_func_03, 3},
	{utc_mm_radio_seek_func_04, 4},
	{NULL, 0}
};
...
void utc_mm_radio_seek_func_01()
{
	...
	tet_infoline( "[[ TET_MSG ]]:: Seek the frequency for the Radio instance" );
	UTC_RADIO_START_ALL(hradio, ret);
	/* Seek the frequency for the instance of the Radio */
	ret = mm_radio_seek(hradio, MM_RADIO_SEEK_DOWN);
...
void utc_mm_radio_seek_func_02()
{
	...
	UTC_RADIO_START_ALL(hradio, ret);
	/* Seek the frequency for the instance of the Radio */
	ret = mm_radio_seek(NULL, MM_RADIO_SEEK_UP);
