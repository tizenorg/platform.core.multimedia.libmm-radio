...
struct tet_testlist tet_testlist[] = {
	{utc_mm_radio_scan_stop_func_01, 1},
	{utc_mm_radio_scan_stop_func_02, 2},
	{NULL, 0}
};
...
void utc_mm_radio_scan_stop_func_01()
{
	...
	tet_infoline( "[[ TET_MSG ]]:: Stop scan the Radio instance" );

	ret = mm_radio_create(&hradio);
	ret = mm_radio_realize(hradio);
	ret = mm_radio_scan_start(hradio);

	/* Stop scan the instance of the Radio */
...
void utc_mm_radio_scan_stop_func_02()
{
	...
	/* Stop the instance of the Radio */
	ret = mm_radio_scan_stop(NULL);
