...
struct tet_testlist tet_testlist[] = {
	{utc_mm_radio_get_frequency_func_01, 1},
	{utc_mm_radio_get_frequency_func_02, 2},
	{NULL, 0}
};
...
void utc_mm_radio_get_frequency_func_01()
{
	...
	tet_infoline( "[[ TET_MSG ]]:: Get frequency for the Radio instance" );
	...
	/* Get frequency for the instance of the Radio */
	ret = mm_radio_get_frequency(hradio, &frequency);
...
void utc_mm_radio_get_frequency_func_02()
{
	...
	/* Get frequency for the instance of the Radio */
	ret = mm_radio_get_frequency(hradio, NULL);
