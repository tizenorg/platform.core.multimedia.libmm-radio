...
struct tet_testlist tet_testlist[] = {
	{utc_mm_radio_start_func_01, 1},
	{utc_mm_radio_start_func_02, 2},
	{NULL, 0}
};
...
void utc_mm_radio_start_func_01()
{
	...
	tet_infoline( "[[ TET_MSG ]]:: Start the Radio instance" );
	...
	ret = mm_radio_start(hradio);
	dts_check_eq(__func__, ret, MM_ERROR_NONE, "err=%x", ret );

	ret = mm_radio_stop(hradio);
